 ...
 */
public class CustomizeExecutorPool {

    private final static Logger LOGGER = LoggerFactory.getLogger(CustomizeExecutorPool.class);
     ...
     * @param notify        通知接口
     */
    public CustomizeExecutorPool(int corePoolSize, int maxSize, long keepAliveTime,
